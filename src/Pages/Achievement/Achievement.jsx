  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-purple-500 font-medium text-sm mb-4">
          {item.organization}
        </p>
  ...
  const achievements = [
    {
      ...
      date: "Dec 2024",
      description:
        "Successfully completed the 'Complete Web Development' course with excellence, building industry-standard projects using JavaScript, React, and the MERN stack.",
      link: "https://drive.google.com/file/d/165gEeIKm9XqxuRaTf43wMVfi4tw7JYV5/view?usp=sharing",
    },
    {
      ...
      date: "Nov 2023",
      description:
        "Recognized for developing an open-source library management system used by 500+ students during the campus tech fest.",
    ...
    },
    {
      ...
      date: "June 2024",
      description:
        "Secured 2nd place among 50 teams by building a real-time disaster management dashboard using React and Firebase.",
      link: "https://drive.google.com/file/d/1MFjgM3taPDCTlZqzzax57t3DWzLlL6Xs/view?usp=sharing",
    },
  ];
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          ...
          >
            ...
            <p className="text-gray-500 italic max-w-xs">
              "Excellence is not an act, but a habit. These are the markers of
              my dedication."
            </p>
          </motion.div>
        </div>
