...
const Projects = () => {
  ...
  const allProjects = [
    {
      ...
      name: "Book Courier",
      description:
        "A full-stack digital library application featuring secure Firebase authentication and comprehensive book management.",
    ...
    },
    {
      ...
      name: "Library Haven",
      description:
        "A high-performance digital library management dashboard focused on modern UI/UX, secure access, and real-time book management.",
      image: "https://i.ibb.co.com/wF6B8Bdy/image.png",
      stack: ["React", "Firebase", "TailwindCSS", "Framer Motion"],
    ...
    },
    {
      ...
      name: "Game Zone",
      description:
        "Interactive dashboard for app discovery using visualization libraries.",
      image: "https://i.ibb.co.com/8gK110bj/image.png",
      stack: ["React.js", "Tailwind CSS", "RESTful APIs", "Recharts"],
    ...
    },
    {
      ...
      name: "Find Apps",
      description:
        "Find Apps is a modern and responsive React web application where users can explore trending apps, view detailed app information, and install or uninstall apps easily.",
    ...
    },
    {
      ...
      name: "Room Decore",
      description:
        "A React app where users can explore and interact with home decor items, view details, and simulate purchases through a modern UI.",
    ...
    },
    {
      ...
      description: "Dynamic weather forecasting application using public APIs.",
  ...
  const foundationProjects = currentProjects.filter(
    (p) => p.type === "beginner"
  );
    ...
    <div className="relative min-h-screen bg-[#050505] pt-24 pb-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <header className="mb-20 text-center relative">
          ...
          >
            Showcasing my evolution as a MERN specialist—from foundational logic
            to elite full-stack ecosystems.
          </motion.p>
        </header>
              ...
              <section className="mb-32">
                <div className="flex items-center gap-6 mb-12">
                  <div className="flex flex-col">
                    <span className="text-[10px] uppercase tracking-[0.4em] text-purple-500 font-bold mb-1">
                      Tier 01
                    </span>
                    <h2 className="text-3xl font-black text-white">
                      Elite Full-Stack Systems
                    </h2>
                  </div>
